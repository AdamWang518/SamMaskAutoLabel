...
def refine_mask(event):
    ...
    if input_points:
        print("Input points:", input_points)  # Debugging line
        ...
        print("All points:", input_points_np)  # Debugging line
        print("All labels:", input_labels_np)  # Debugging line

        try:
            masks = prompt_process.point_prompt(points=input_points_np, pointlabel=input_labels_np)  # 使用正確的參數
        except Exception as e:
            print("Error during point_prompt:", e)
            return

        print("Masks generated:", len(masks))  # Debugging line

        if len(masks) > 0:
            final_mask = masks[0]  # Choose the first mask, adjust if needed
            print("Final mask shape:", final_mask.shape)  # Debugging line
            print("Final mask data (first 5x5 elements):\n", final_mask[:5, :5])  # Debugging line
            ...
            print("Initial mask updated.")  # Debugging line
            print("Initial mask data (first 5x5 elements):\n", initial_mask[:5, :5, :])  # Debugging line
            ...
            print("Mask info updated.")  # Debugging line
            ...
            print("Image updated.")  # Debugging line
        ...
        print("No input points to refine.")
def reset(event):
